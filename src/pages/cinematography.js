                ...
                <div className="mx-auto">
                    <div className="flex justify-center">
                        <ul className="list-none button-group filters-button-group p-6">
                            <li  className='mx-3 cursor-pointer is-checked' data-filter="*">All</li>
                            <li  className='mx-3 cursor-pointer' data-filter=".music_video">Music Video</li>
                            <li  className='mx-3 cursor-pointer' data-filter=".fiction">Fiction</li> 
                            <li  className='mx-3 cursor-pointer' data-filter=".documentary">Documentary</li>
                            <li  className='mx-3 cursor-pointer' data-filter=".commercials">Commercials</li> 
                        </ul>
                    </div>
                </div>
                <div className='item mx-auto flex items-center flex-wrap -mt-2'> 
                    {items.map(({ node: item }) => (
                        <Cineitem
                            title={item.title}
